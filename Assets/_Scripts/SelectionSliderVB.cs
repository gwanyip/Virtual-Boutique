...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionSliderVB : MonoBehaviour
    {
        ...
        [SerializeField] private MediaPlayerCtrl m_360VideoCtrl;            // Media Player Ctrl for the 360 video
